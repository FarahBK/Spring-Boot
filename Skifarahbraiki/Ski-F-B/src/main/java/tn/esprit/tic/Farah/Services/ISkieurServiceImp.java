...
import tn.esprit.tic.Farah.Repositories.*;
...
//        return null;}
    ...
    @Override
    public List<Skieur> findSkieurByAbonnement_TypeAbonSQL(TypeAbonnement typeAbonnement, String ville) {
        return skieurRepository.findSkieurByAbonnement_TypeAbonSQL(typeAbonnement,ville);
    }

    @Override
    public List<Skieur> findByInscriptionCoursSupportAndInscriptionCoursCoursMonitorMoniteurNom(Support support, String nom) {
        return skieurRepository.findByInscriptionCoursSupportAndInscriptionCoursCoursMonitorMoniteurNom(support,nom);
    }
}
